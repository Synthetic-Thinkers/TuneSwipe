          ...
          <>
            ...
            <View style={styles.instructContainer}>
              ...
              <Text style={styles.directionsText}>
                <Text style={styles.rightText}>right</Text> to like,{" "}
                <Text style={styles.leftText}>left</Text> to dislike.
              </Text>
              ...
              <View style={styles.cardContainer}>
                ...
                <View style={styles.choiceContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => goToSample(card.id)}
                  >
                    <AntDesign name="infocirlceo" size={48} color="white" />
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  centerButtons: {
    flexDirection: "row",
    alignItems: "center",
    gap: 20, // space between close and heart buttons
  },
  turntableIcon: {
    flex: 1,
    width: 100,
