...
with_node \
  ...
  --target "/Users/tanishanaik/Documents/new491/TuneSwipe/ios/Pods/Target Support Files/Pods-TuneSwipe/ExpoModulesProvider.swift" \
  --entitlement "/Users/tanishanaik/Documents/new491/TuneSwipe/ios/TuneSwipe/TuneSwipe.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
